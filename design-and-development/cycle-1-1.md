...
To begin my cycles development to add to coin to the game i proceed to create a coin for my game however shilt look for design example i came acroos a coin the was already stored as a assect in kaboom.js , i opted to use the coin provied with in kaboom as it simple , regionsable by the player and kept in line with the theme was tryin to create.

![](<../.gitbook/assets/image (4) (4).png>)

Once i found the coin that appropriate for my game i add the coins file address to the code of my game as well giving the tag "coin" for easy future refferent enabling me to save time.
