...
From the image above it shows there are many different way for the player to get to the exit with out dieing.this is prodomeanly due to the platfrom placed in a way that give gap to jump through. This was all tested usability testin with the test player coming to the same conconlustion. Overall i consider the success criteria has been met.
