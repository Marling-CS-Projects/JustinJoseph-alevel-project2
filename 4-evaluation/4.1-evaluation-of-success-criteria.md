...
l have added a moving platform to my game which is shown in cycle 9.  I know that I successfully achieved my set criteria,  I became more creative and proceeded to make an alteration with the same code.This lead me to create the acid bath thus providing the player with an additional challenge.
...
This success criteria was done through a survey during a usability test . ith most of the response agreeing that they like the colour and the design of the game . Overall this criterion was met.
