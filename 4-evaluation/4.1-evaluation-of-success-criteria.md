...
When you load into the game you will  be greeted by two large buttons that will take you to the chosen place . the menu provide the game with a look of completeness whilst enable to add sub feature enabling the player to chose what is best for them and not rushing the player into the game but instead allowing then to make the desion. this sucess certia was met to a good standard.&#x20;

## criterion 16

The puase button was a feature that would have allow the player to temportary pause the game if they player was over welled by the game or any personal reason. I was not able to implement this fearute as did not understand how to proceed with the feature and how to make with. Even tho effectwas to made to creat one with did not function correctly and as i was not keen to provide the player with a bugs game i desicde to remove the feature.

## criterion 17

The feature was met in the cycle 4 with it being fully function. The only bug with teh stopwatch can be seen in the image above . As you can see the counter and stopwatch is together with no space this is a simple fix and will done during when fixing the other bug in the game. Overall this criterion was met&#x20;

## criterion 18

This is sucess sceria was a done through a suvery during usabullty test . with the most of the reposne agreing that they like the colour and the design of the game . Overall this criterion was met.&#x20;



## criterion 19

As you can see the games scened in the game was desgined in a simple manner as the only pourse for them was the let the player know if they complted the game sucfully or not.  Overall this critertion was met&#x20;
