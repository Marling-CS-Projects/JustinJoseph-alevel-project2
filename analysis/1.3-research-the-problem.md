...
As the game was developed for mobile devices, the controls will be done in a simple manner. The player will have the choice of either a swiping feather for movement or an arrow ( whilst  B is used for jump ). To attck the player has the ability to use A.  From experience, the use of the mobile control such as present in Shadow blade + is a fatigiuing  to use for long period of time. As a result, I wish not to use it.&#x20;
...
| ------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|                                 |                                                                                                                                                                                                                            |
| the endless death system        | Without a death system that has no end until the player completes the level will remove one of the risk factors compared to having a limited number of tries before you have failed a level and have to restart the level. |
...
| the weakness of the bots (npcs) | even tho i am incorpating bots in my game  i believe  that the bots should take more hits                                                                                                                                  |
{% endtab %}
{% endtabs %}
...
Developed by nintedo intened for the wii gaming console the controls for the game uses a joystick style controler .  The arrow buttons enble the movement of the characheter like wise the two addtioanl buttons control the jumping of the charachter whilst the other button contosl the power ups , lasty by holding the second button it will enable sprint mode .&#x20;
