...
| simple controls               | BY make the control simple to interact with it helps the player to spend less time to learn the controls for the game and instead spend  more time on the game it self , in addition  because i am developing this game for the web bowser    |
{% endtab %}
