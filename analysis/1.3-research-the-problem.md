...
As the game was developed for mobile devices , the controls will be done in a simple manner. The player will have the choice of either a swiping feather for movement or arrow ( whilst  B is used for jump ) . To attck the player has the ablity to use A  .  From experience the use of the mobile control such as present in Shadow blade + is a fertiging  to use for long period of time . As a result i wish not to use it .&#x20;
