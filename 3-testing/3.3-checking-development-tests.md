...
| 2    | the win  scene                | when the player goes through the final portal the win must be display with the win scene to symbolizes that they have completed the game  | runs as mentioned      | Pass      |
...
As i am unable to record i can say that the falling death feature works from test and when the player jumps from a high or fall of the side of the game the falling death feature actives . As a prove of this when the player dies from falling of high the image beloew is shown
